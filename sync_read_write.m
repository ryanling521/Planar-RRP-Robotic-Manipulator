...
DXL_MINIMUM_POSITION_VALUE  = 0;%-10000; %-150000;      % Dynamixel will rotate between this value
DXL_MAXIMUM_POSITION_VALUE  = 2000; %10000; %150000;       % and this value (note that the Dynamixel would not move when the position value is out of movable range. Check e-manual about the range of the Dynamixel you use.)
...
write1ByteTxRx(port_num, PROTOCOL_VERSION, DXL0_ID, ADDR_PRO_TORQUE_ENABLE, TORQUE_ENABLE);
...
%     dxl_addparam_result = groupSyncWriteAddParam(groupwrite_num, DXL0_ID, typecast(int32(dxl_goal_position(index)), 'uint32'), LEN_PRO_GOAL_POSITION);
%     if dxl_addparam_result ~= true
